...
/*static*/ void HNSWGraphOperations::LocalGraphConstructionBruteForce(float* h_data, int num_of_final_neighbors, int total_num_of_points, int dim_of_point, int num_of_initial_neighbors,
...
/*static*/ void HNSWGraphOperations::LocalGraphMergenceCoorperativeGroup(float* d_data, int* &h_graph, int total_num_of_points, int dim_of_point, int num_of_initial_neighbors, int num_of_batches,
                                                    int num_of_points_one_batch, KernelPair<float, int>* d_neighbors_backup, int num_of_final_neighbors,
                                                    int num_of_candidates, std::pair<float, int>* first_subgraph, int num_of_layers, int* num_of_points_on_each_layer){
...
/*static*/ void HNSWGraphOperations::Search(float* h_data, float* h_query, int* h_graph, int* h_result, int num_of_query_points, int total_num_of_points, int dim_of_point, int num_of_initial_neighbors,
